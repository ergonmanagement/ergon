...
export function MobileShell({ user, children }: MobileShellProps) {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-white">
            ...
            {/* Mobile Drawer */}
            <nav className={`fixed top-16 left-0 w-64 h-full bg-white border-r border-gray-200 transform transition-transform duration-300 ease-in-out z-50 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'
                }`}>
